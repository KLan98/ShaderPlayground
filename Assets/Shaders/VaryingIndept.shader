    ...
    SubShader
    {
        Pass
        {
            ...
            void main()
            {
                ...
                float t = Remap(localSpacePosition.x, -5.0, 5.0, 0.0, 1.0);
            ...
            void main()
            {
                ...
                float t = Remap(localSpacePosition.z, -5.0, 5.0, 0.0, 1.0);
                ...
                if (t > 0.5)
                {
                    ...
                    float val = EaseInSine(Remap(localSpacePosition.x, -5.0, 5.0, 0.0, 1.0));
